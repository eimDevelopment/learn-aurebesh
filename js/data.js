...
const WORD_LISTS = {
  ...
  5: [
    ...
    'armor', 'avoid', 'award', 'aware', 'badly', 'basic', 'begin', 'below',
    'bible', 'blade', 'blame', 'blast', 'blind', 'block', 'blood', 'board',
    'bonus', 'brain', 'brand', 'brave', 'bread', 'break', 'brief', 'broad',
    'broke', 'brown', 'build', 'built', 'buyer', 'cabin', 'cable', 'cargo',
    'carry', 'claim', 'class', 'clean', 'clear', 'climb', 'cloak', 'clock',
    'clone', 'close', 'cloud', 'color', 'could', 'count', 'court', 'cover',
    'crack', 'craft', 'crazy', 'cream', 'crest', 'crime', 'cross', 'crowd',
    'cruel', 'curve', 'cycle', 'daily', 'dance', 'decoy', 'delay', 'delta',
    'dirty', 'doubt', 'draft', 'drain', 'drama', 'drawn', 'dream', 'dress',
    'drink', 'drive', 'droid', 'early', 'eight', 'elite', 'empty', 'enemy',
    'enjoy', 'enter', 'equal', 'error', 'event', 'every', 'exact', 'exile',
    'exist', 'extra', 'false', 'fault', 'favor', 'fence', 'fever', 'field',
    'fifty', 'fight', 'final', 'first', 'flame', 'fleet', 'float', 'flood',
    'floor', 'fluid', 'focus', 'force', 'forge', 'forum', 'found', 'frame',
    'fraud', 'front', 'fruit', 'fully', 'funny', 'given', 'glass', 'globe',
    'grace', 'grade', 'grain', 'grand', 'grant', 'grass', 'grave', 'great',
    'green', 'gross', 'group', 'grown', 'guard', 'guess', 'guest', 'guide',
    'guild', 'guilt', 'happy', 'heart', 'heavy', 'hello', 'horse', 'hotel',
    'house', 'human', 'humor', 'hyper', 'ideal', 'image', 'imply', 'index',
    'inner', 'input', 'issue', 'ivory', 'joint', 'judge', 'juice', 'known',
    'kyber', 'label', 'large', 'laser', 'later', 'layer', 'learn', 'least',
    'leave', 'legal', 'level', 'light', 'limit', 'linen', 'liver', 'local',
    'logic', 'loose', 'lover', 'lower', 'lucky', 'magic', 'major', 'maker',
    'manor', 'marry', 'medal', 'media', 'mercy', 'merit', 'metal', 'midst',
    'might', 'model', 'money', 'moral', 'motor', 'mount', 'movie', 'music',
    'naive', 'nerve', 'never', 'night', 'noble', 'noise', 'novel', 'nurse',
    'occur', 'ocean', 'offer', 'often', 'orbit', 'order', 'organ', 'outer',
    'owner', 'paint', 'panel', 'paper', 'party', 'pasta', 'pause', 'peace',
    'penny', 'pilot', 'pizza', 'place', 'plain', 'plane', 'plant', 'plate',
    'plaza', 'plead', 'plumb', 'point', 'pound', 'power', 'press', 'price',
    'pride', 'prime', 'print', 'prior', 'prize', 'probe', 'proof', 'proud',
    'prove', 'psalm', 'purge', 'purse', 'queen', 'quest', 'quiet', 'quota',
    'radar', 'radio', 'raise', 'rapid', 'ratio', 'ready', 'realm', 'rebel',
    'reign', 'relax', 'reply', 'rider', 'right', 'rigid', 'risky', 'rival',
    'river', 'robot', 'rocky', 'rogue', 'royal', 'rural', 'saber', 'saint',
    'salad', 'scale', 'score', 'scout', 'sense', 'serve', 'setup', 'seven',
    'siege', 'sight', 'silly', 'since', 'sixty', 'skill', 'sleep', 'slide',
    'slope', 'small', 'smart', 'smile', 'smoke', 'snake', 'solar', 'solid',
    'solve', 'sorry', 'sound', 'space', 'spare', 'speak', 'speed', 'spend',
    'spice', 'spill', 'spite', 'split', 'sport', 'spray', 'squad', 'stack',
    'staff', 'stage', 'stair', 'stake', 'stale', 'stand', 'stark', 'start',
    'state', 'steal', 'steam', 'steel', 'steep', 'steer', 'stick', 'stiff',
    'still', 'stock', 'stone', 'stood', 'store', 'storm', 'story', 'strip',
    'stuck', 'study', 'stuff', 'style', 'sugar', 'super', 'surge', 'swamp',
    'swear', 'sweep', 'sweet', 'sword', 'table', 'taste', 'tears', 'tempo',
    'tense', 'terms', 'tight', 'timer', 'tired', 'title', 'today', 'token',
    'total', 'tower', 'toxic', 'trace', 'track', 'trade', 'trail', 'train',
    'trait', 'treat', 'trend', 'trial', 'tribe', 'trick', 'troop', 'truck',
    'truly', 'trust', 'tumor', 'twice', 'twist', 'ultra', 'uncle', 'under',
    'unity', 'until', 'upper', 'upset', 'urban', 'usage', 'usual', 'valid',
    'value', 'verse', 'vigor', 'viral', 'visit', 'vital', 'vivid', 'vocal',
    'voter', 'waste', 'water', 'weary', 'weave', 'weigh', 'weird', 'wheel',
    'where', 'while', 'white', 'whole', 'whose', 'woman', 'world', 'worry',
    'worst', 'would', 'wound', 'write', 'yield',
  ],
  6: [
